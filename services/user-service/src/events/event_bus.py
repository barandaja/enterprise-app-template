...
class InMemoryEventBus(IEventBus):
    ...
    async def subscribe_to_all(
        ...
        try:
            ...
            logger.info("Global handler subscribed", extra={"handler": handler.__name__})
            return True
    ...
    async def unsubscribe_from_all(
        ...
        try:
            ...
            logger.info("Global handler unsubscribed", extra={"handler": handler.__name__})
            return True
    ...
    async def get_statistics(self) -> Dict[str, int]:
        ...
        try:
            ...
            logger.error("Failed to get event bus statistics", extra={"error": str(e)})
            return {}
